...
const CONTRACT_NAME: &str = "crates.io:cw2981-configuration";
...
pub struct Metadata {
    ...
    /// The payment address, may be different to or the same as the minter addr
...
impl Default for Metadata {
    fn default() -> Self {
        Metadata {
            ...
            configuration_image_url: String::new(),
            image_sha: String::new(),
            crossplane_version: String::new(),
        }
    }
}
...
mod tests {
    ...
    fn use_metadata_extension() {
        ...
        let extension = Some(Metadata {
            ...
            configuration_image_url: "http://example.com/configuration-image.yaml".to_string(),
            image_sha: "abc123def456".to_string(),
            crossplane_version: "v1.2.3".to_string(),
            ..Metadata::default()
        });
    ...
    fn check_token_royalties() {
        ...
        let voyager_exec_msg = ExecuteMsg::Mint {
            ...
            extension: Some(Metadata {
                ...
                configuration_image_url: "http://example.com/configuration-image.yaml".to_string(),
                image_sha: "fed654cba987".to_string(),
                crossplane_version: "v1.3.0".to_string(),
                ..Metadata::default()
            }),
        };
